...
public class q5 {
    public static void main(String[] args) throws IOException {
        ...
        int i=1;
        while (flag) {
            String filePath = "C:\\Users\\DELL\\OneDrive\\Documents\\price.txt",
                    totalfilePath = "C:\\Users\\DELL\\OneDrive\\Documents\\totalprice.txt";
            System.out.print("Select your option (");
            System.out.print("1: Insert price, ");
    ...
    public static void main1(String[] args) throws IOException {
        try (FileWriter fw = new FileWriter("C:\\Users\\DELL\\OneDrive\\Documents\\totalprice.txt", true);
             BufferedWriter bw = new BufferedWriter(fw);
             PrintWriter out = new PrintWriter(bw)) {
            out.println(100);
        } catch (Exception e) {
